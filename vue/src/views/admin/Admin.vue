<template>
    <div>
        ...
        <div style="margin-bottom:1px">
            <el-input style="width: 240px" placeholder="请输入管理员用户名" v-model="params.userName"></el-input>
            <el-input style="width: 240px; margin-left: 5px" placeholder="请输入管理员邮箱" v-model="params.email"></el-input>
