<template>
    <div>
        ...
        <div style="margin-bottom:1px">
            <el-input style="width: 240px" placeholder="请输入图书分类名" v-model="params.name"></el-input>
        ...
        <el-table :data="tableData" stripe>
            <el-table-column prop="name" label="图书分类名"></el-table-column>
